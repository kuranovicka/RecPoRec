...
class DocumentListActivity : AppCompatActivity() {
     ...
     * i tekst se jasno oznacava kao "iz OCR-a" u nazivu, da zna otkud je dosao. */
        ...
        lifecycleScope.launch {
            val recognizedText = withContext(Dispatchers.IO) {
                try {
                    ...
                    // ML Kit-ov API je asinhron (Task) - ovde ga cekamo sinhrono preko Tasks.await(),
                    // bezbedno je jer smo vec na pozadinskoj (IO) niti.
